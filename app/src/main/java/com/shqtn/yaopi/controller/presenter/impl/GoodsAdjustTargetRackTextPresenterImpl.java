...
public class GoodsAdjustTargetRackTextPresenterImpl extends NormalTextPresenterImpl {
    public GoodsAdjustTargetRackTextPresenterImpl() {
        ...
        TextPresenterBean bean = new TextPresenterBean("货位调整", "请扫描调入货位条码",
                ScanningBoxActivity.class, GoodsAdjustAddBoxPresenterImpl.class, ParamsFactory.GoodsAdjust.createScanningManfiest()
                , new OperateBoxBean(false, ParamsFactory.GoodsAdjust.createScanningBoxNo(),
                null,
                ParamsFactory.GoodsAdjust.createSubmit()));
